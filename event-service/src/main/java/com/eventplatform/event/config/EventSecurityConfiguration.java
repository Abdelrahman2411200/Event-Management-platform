...
public class EventSecurityConfiguration {
    ...
    SecurityFilterChain eventSecurityFilterChain(
            ...
            JwtAuthenticationConverter eventJwtAuthenticationConverter) throws Exception {
        return http
                ...
                .oauth2ResourceServer(oauth2 -> oauth2
                        .jwt(jwt -> jwt.jwtAuthenticationConverter(eventJwtAuthenticationConverter))
    ...
    @Bean
    JwtAuthenticationConverter eventJwtAuthenticationConverter() {
