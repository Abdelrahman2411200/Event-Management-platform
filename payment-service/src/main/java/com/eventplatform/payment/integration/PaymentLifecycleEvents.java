...
public final class PaymentLifecycleEvents {
 ...
 public record PaymentChangedV1(UUID paymentId,UUID bookingId,UUID attendeeId,UUID eventId,BigDecimal amount,String currency,PaymentStatus status,String failureCode,String failureReason,Instant occurredAt){}
 public record RefundChangedV1(UUID refundId,UUID paymentId,UUID bookingId,UUID attendeeId,BigDecimal amount,String currency,List<UUID> ticketIds,boolean full,String failureCode,String failureReason,Instant occurredAt){}
}
