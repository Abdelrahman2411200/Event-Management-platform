package com.eventplatform.venue.config;
...
public class VenueSecurityConfiguration {

    @Bean
    SecurityFilterChain venueSecurityFilterChain(
            HttpSecurity http,
            ApiErrorResponseWriter errorWriter,
            JwtAuthenticationConverter venueJwtAuthenticationConverter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(
                                ...
                                "/swagger-ui.html")
                        .permitAll()
                        .requestMatchers("/api/v1/venues/**")
                        .authenticated()
                        .anyRequest()
                        .denyAll())
                .oauth2ResourceServer(oauth2 -> oauth2
                        .jwt(jwt -> jwt.jwtAuthenticationConverter(venueJwtAuthenticationConverter))
    ...
    @Bean
    JwtAuthenticationConverter venueJwtAuthenticationConverter() {
